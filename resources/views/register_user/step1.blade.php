  ...
  <div class="container">
    ...
    <div class="card">
      <div class="card-header">
        <h5 class="card-title">Step 1. Personal Information</h5>
      </div>
     @php
     ...
     @endphp
      ...
      @if ($errors->any())
        ...
        @endif
      <form action="{{ url('/register/profile/proceed')}}" method="post">
        @csrf
        <div class="card-body">
        ...
        <div class="card-footer">
          <button type="submit" class="btn btn-raised btn-info"><i class="fas fa-angle-double-right"></i> Next Step </button>
        </div>      
      </form>
    </div>
  </div>
